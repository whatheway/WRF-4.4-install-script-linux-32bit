...
export MET_PYTHON_LD=-L${MET_PYTHON}/lib/python3.8/config-3.8-x86-linux-gnu\ -L${MET_PYTHON}/lib\ -lpython3.8\ -lcrypt\ -lpthread\ -ldl\ -lutil\ -lm   
...
cd 
$HOME/WRF-4.4-install-script-linux-32bit/METplus_self_install_script_Linux_32bit.sh
