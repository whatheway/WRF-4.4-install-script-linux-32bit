...
wget -c https://sourceforge.net/projects/opengrads/files/grads2/2.2.1.oga.1/Linux%20%2832%20Bits%29/opengrads-2.2.1.oga.1-bundle-i686-pc-linux-gnu-glibc_2.12.tar.gz
...
#############################################################################
cd $HOME/WRF/Downloads
tar -xzvf opengrads-2.2.1.oga.1-bundle-i686-pc-linux-gnu-glibc_2.12.tar.gz -C $HOME/WRF
cd $HOME/WRF
...
source $HOME/WRF-4.4-install-script-linux-32bit/Miniconda3_WRF_Install.sh
...
$HOME/WRF-4.4-install-script-linux-32bit/MET_self_install_script_Linux_32bit.sh
